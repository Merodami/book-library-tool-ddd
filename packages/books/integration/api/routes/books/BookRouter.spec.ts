import { createMockEventBus } from '@book-library-tool/event-store'
...
import { createBookRouter } from '@books/api/index.js'
import {
...
describe('Book Router Integration Tests', () => {
  ...
  let mockProjectionRepository: ReturnType<
    typeof createMockBookReadProjectionRepository
  >
