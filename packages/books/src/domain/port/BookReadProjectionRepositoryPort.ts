...
import { MongoReadProjectionRepositoryPort } from '@book-library-tool/database'
...
/**
 * BookReadProjectionRepository abstracts the persistence and retrieval of book projections
 * for Book aggregates. It ensures optimistic concurrency via version checking.
 */
export interface BookReadProjectionRepositoryPort
  extends MongoReadProjectionRepositoryPort<BookDocument, DomainBook> {
  /**
