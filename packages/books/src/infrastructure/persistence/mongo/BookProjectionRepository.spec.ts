...
import { BookDocument } from '@books/infrastructure/index.js'
...
describe('BookProjectionRepository', () => {
  ...
  let repositoryRead: BookReadProjectionRepository
  let repositoryWrite: BookWriteProjectionRepository
  let mockBook: DomainBook
  ...
  beforeEach(() => {
    ...
    mockCollection = {
      ...
      insertOne: vi.fn().mockResolvedValue({ insertedId: mockDocument.id }),
      updateOne: vi
        .fn()
    ...
    repositoryRead = new BookReadProjectionRepository(
      mockCollection as unknown as Collection<BookDocument>,
    )
    repositoryWrite = new BookWriteProjectionRepository(
      mockCollection as unknown as Collection<BookDocument>,
    )
  })
  ...
  describe('getBookById', () => {
    it('should return a book when it exists', async () => {
      const result = await repositoryRead.getBookById({ id: mockId })
    ...
    it('should return null when book does not exist', async () => {
      ...
      const result = await repositoryRead.getBookById({
        id: 'non-existent-id',
      })
  ...
  describe('getBookByIsbn', () => {
    it('should return a book when it exists', async () => {
      const result = await repositoryRead.getBookByIsbn(mockBook.isbn!)
    ...
    it('should return null when book does not exist', async () => {
      ...
      const result = await repositoryRead.getBookByIsbn('non-existent-isbn')
    ...
    it('should apply field projection when fields are specified', async () => {
      ...
      await repositoryRead.getBookByIsbn(mockBook.isbn!, fields)
  ...
  describe('getAllBooks', () => {
    it('should return paginated books', async () => {
      ...
      const result = await repositoryRead.getAllBooks(query)
    ...
    it('should apply text search filters', async () => {
      ...
      await repositoryRead.getAllBooks(query)
  ...
  describe('saveProjection', () => {
    it('should save a new book projection', async () => {
      ...
      await repositoryWrite.saveBookProjection(mockBook)
    ...
    it('should throw an error when required fields are missing', async () => {
      ...
      const incompleteBook: DomainBook = {
        id: mockId,
      ...
      await expect(
        repositoryWrite.saveBookProjection(incompleteBook),
  ...
  describe('updateBookProjection', () => {
    it('should update an existing book projection', async () => {
      ...
      await repositoryWrite.updateBookProjection(mockId, updateData, updateDate)
  ...
  describe('markAsDeleted', () => {
    it('should mark a book as deleted', async () => {
      ...
      await repositoryWrite.markAsDeleted(mockId, deletedAt)
