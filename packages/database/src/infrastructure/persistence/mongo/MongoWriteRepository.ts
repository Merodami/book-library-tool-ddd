...
import { getNextGlobalVersion } from '@database/infrastructure/index.js'
import { MongoRepository } from '@database/infrastructure/index.js'
import { MongoDatabaseServicePort } from '@database/port/MongoDatabaseServicePort.js'
import { Collection } from 'mongodb'

export abstract class MongoWriteRepository<
...
> extends MongoRepository<T> {
  ...
  constructor(
    ...
    protected readonly dbService: MongoDatabaseServicePort,
  ) {
    super(collection)
  }
